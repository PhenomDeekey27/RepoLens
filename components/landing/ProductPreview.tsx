    ...
    <section className="px-4 py-12 md:py-16 max-w-5xl mx-auto">
      <div className="rounded-lg border border-outline-variant bg-surface-container-low overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row">
          {/* Left sidebar */}
          <div className="w-full md:w-48 border-b md:border-b-0 md:border-r border-outline-variant bg-surface-container-low p-3">
          ...
          <div className="flex-1 p-4">
            ...
            <div className="mb-4 p-3 rounded border border-outline-variant bg-surface-container">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-xs font-semibold uppercase tracking-wider text-on-surface-variant">
                  Root Cause Identified
                </span>
                <span className="px-2 py-0.5 text-xs rounded bg-primary-container/20 text-primary-container">
                  94% confidence
                </span>
              </div>
