...
export const MODEL_REGISTRY: ModelEntry[] = [
  ...
  // ── DeepSeek via OpenRouter (benchmark testing) ──
  {
    ...
    longContextScore: s(5),
    structuredOutput: true,
    recommendedFor: ['simple_coding', 'fast_generation', 'evidence_extraction', 'code_generation'],
  },
  {
  ...
  },
  {
    ...
    longContextScore: s(3),
    structuredOutput: true,
    recommendedFor: ['simple_coding', 'evidence_extraction', 'validation', 'formatting'],
  },
